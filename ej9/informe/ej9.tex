...
\begin{figure}[H]
 \centering
  \subfloat[Respuesta al escalón]{
   \label{f:ejaesc}
    \includegraphics[width=0.7\textwidth]{figures/a-escalon.png}}
  \subfloat[Respuesta al impulso]{
   \label{f:ejaimp}
    \includegraphics[width=0.7\textwidth]{figures/a-impulso.png}}
...
\begin{figure}[H]
 \centering
  \subfloat[Respuesta al escalón]{
   \label{f:ejbesc}
    \includegraphics[width=0.7\textwidth]{figures/b-escalon.png}}
  \subfloat[Respuesta al impulso]{
   \label{f:ejbimp}
    \includegraphics[width=0.7\textwidth]{figures/b-impulso.png}}
